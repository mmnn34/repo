...
{
	background-image: url('/DXR.axd?r=1_14-tZwj7');
}
...
.dxtcScrollButton 
{
	...
	background: #E8E7E8 url('/DXR.axd?r=1_30-tZwj7') repeat-x;
    cursor: pointer;
    text-align: center;
    padding: 6px;	
}
...
{
	background: #F4F4F4 url('/DXR.axd?r=1_32-tZwj7') repeat-x;
}
...
.dxtcScrollButtonDisabled
{
	cursor: default;
	border-color: #C3C3C3;
	background: #E6E7E8 url('/DXR.axd?r=1_31-tZwj7') repeat-x;
}
/* Misc */
.dxtcLeftAlignCell,
...
.dxucBrowseButton
{
    padding: 3px 8px 4px;
    border: solid 1px #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_37-tZwj7') top;
    background-repeat: repeat-x;
}
.dxucBrowseButtonHover
{
    border: solid 1px #606060;
	background: #F2F2F2 url('/DXR.axd?r=1_38-tZwj7') top;
    background-repeat: repeat-x;
}
...
{
	background-image: url('/DXR.axd?r=1_27-tZwj7');
...
.dxtvControl .dxtv-ln
{
	background-image: url('/DXR.axd?r=1_35-tZwj7');
	background-repeat: repeat-y;
	vertical-align: top;
}
...
.dxtvControl .dxtv-elb
{
	background-image: url('/DXR.axd?r=1_33-tZwj7');
...
.dxtvControl.dxtvRtl .dxtv-elb
{
    background-image: url('/DXR.axd?r=1_34-tZwj7');
}
...
{
	width:3px;
	background: url('/DXR.axd?r=1_12-tZwj7') right;
	background-repeat:repeat-y;
	border: 0px;
}
